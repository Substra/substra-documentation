...
- dump the database
    - for substrapp, it's easiest to `do so through Django <https://github.com/Substra/substra-backend/blob/016806fc8e43da4d566425cfbae9c73d5256337e/UPGRADE.md#backup-and-restore-django-databases>`__ (you get a JSON file)
