...
.. list-table::
   ...
   * - 0.24.0
     ...
     - `0.34.0 <https://github.com/Substra/substra-backend/releases/tag/0.34.0>`__ | `helm 22.2.3 <https://artifacthub.io/packages/helm/substra/substra-backend/22.2.3>`__
     - `0.31.0 <https://github.com/Substra/orchestrator/releases/tag/0.31.0>`__ `helm 7.4.6 <https://artifacthub.io/packages/helm/substra/orchestrator/7.4.6>`__
     - `0.38.0 <https://github.com/Substra/substra-frontend/releases/tag/0.38.0>`__ | `helm 1.0.10 <https://artifacthub.io/packages/helm/substra/substra-frontend/1.0.10>`__
