...
def setup_mnist(data_path, N_CLIENTS):
    ...
    train_images_folds = np.array_split(train_images, N_CLIENTS)
    train_labels_folds = np.array_split(train_labels, N_CLIENTS)
    test_images_folds = np.array_split(test_images, N_CLIENTS)
    test_labels_folds = np.array_split(test_labels, N_CLIENTS)
